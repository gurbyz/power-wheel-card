...
describe('<power-wheel-card> with most basic config', () => {
  ...
  it('has set default config values', (done) => {
    // flush(() => {
  ...
  it('has set card property values after setConfig', (done) => {
    // flush(() => {
  ...
  it('has no warnings or errors', (done) => {
    // flush(() => {
  ...
  it('displays values when consuming from the grid', (done) => {
    // flush(() => {
  ...
  it('has ui elements when consuming from the grid', (done) => {
    // flush(() => {
  ...
  xit('displays values when producing to the grid', (done) => {
  ...
  xit('has ui elements when producing to the grid', (done) => {
    setCardProducingToGrid();
  ...
  xit('displays values when all sensor values are zero', (done) => {
    setCardAllInactive();
  ...
  xit('has ui elements when all sensor values are zero', (done) => {
    setCardAllInactive();
  ...
  xit('displays values when solar inverter consumes power', (done) => {
  ...
  xit('has ui elements when solar inverter consumes power', (done) => {
    setCardSolarConsuming();
  ...
  xit('updates when sensor value changes', (done) => {
    // flush(() => {
